...
class MartiCDManager {
    
    static let sharedInstance = MartiCDManager()
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("martiPro", withExtension: "momd")!
